                        ...
                        <div class="col-md-6 col-xl-5">
                         ...
                         <div class="col-md-6">
                            <div class="slider-image">
                               <img width="450" height="450" class="owl-lazy img-fluid slider-img" data-src="{{$slido->photo ? 'public/images/media/' . $slido->photo->file : 'img/200x200.png'}}" alt="" >
                            </div>
                         </div>
                     </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="col-project-big">
                            <div class="col-project-inner">
                                    ...
                                    <img src="img/loading-blog.gif" width="500" height="820" class="lazy img-fluid" data-src="{{$project->photo ? 'public/images/media/' . $project->photo->file : 'img/200x200.png'}}" alt="{{$project->title}}"></a>
