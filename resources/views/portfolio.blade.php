                  ...
                  <div class="projects row">
                      ...
                      <div class="project col-md-6" data-filter="{{$project->project_category->name}}">
                          <div class="project-thumbnail">
                              <a href="{{URL::to('/')}}/project/{{$project->slug}}" title=""><img width="400" height="250" src="img/loading-blog.gif" data-src="{{$project->photo ? 'public/images/media/' . $project->photo->file : 'img/200x200.png'}}" class="lazy img-fluid" alt="{{$project->title}}"></a>
                          </div>
