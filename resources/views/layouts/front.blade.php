           ...
           <div class="container">
              <div class="row">
                 <div class="ct-topbar-meta">
                    ...
                    <div class="ct-topbar-item"> <i class="fas fa-envelope-open"></i> <a href="mailto:@php echo $setting->contact; @endphp">@php echo $setting->contact; @endphp</a></div>
                ...
                <div class="row w-100">
                    ...
                    <div class="navbar-header col-6 col-md-2">
                        <a class="navbar-brand" href="{{url('/')}}" title="{{$setting->title}}">
                            <img width="123" height="37" class="img-fluid logo-front" src="{{$setting->photo ? 'public/images/media/' . $setting->photo->file : '/public/img/logo.png'}}" alt="">
                        </a>
                                    ...
                                    @foreach( $menus->sortBy('order') as $prod )
                                        ...
                                        @if($prod->on_off_submenu == 1)
                                           <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="{{$prod->link}}"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{$prod->name}}
                                                </a>
                                                {!! $prod->submenu !!}
                                            </li>
                                        @else 
                                             <li class="nav-item"> <a title="{{$prod->name}}" class="nav-link" href="{{$prod->link}}">{{$prod->name}}</a> </li>
                                        @endif
                                    @endforeach
                    ...
                    <div class="navbar-buttons  col-6  col-md-2">
                        <a href="contato" target="_self" class="btn btn-peca mt-3"><span>PEÇA JÁ O SEU!</span></a>
                    </div>
