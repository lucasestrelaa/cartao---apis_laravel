...
class ClinicasEspecialidadesController extends Controller
{
    //
    ...
    public function mostrar(){
        $clinicaEspecialidade = ClinicaEspecialidade::all();
        return json_encode($clinicaEspecialidade);
    }
    public function mostrarEspecialidade($id){
        $clinicasespecialidades = Clinicas::where('id', $id)->get();
        return json_encode($clinicasespecialidades);
    }
